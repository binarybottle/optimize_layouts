...
"""
--------------------------------------------------------------------------------
Generate 73,440 configuration files to run keyboard layout optimizations 
...
OUTPUT_DIR = '../output/configs1_assign_4_14_per_73440_files'
CONFIG_FILE = '../config.yaml'
nlayouts = 1

# Items in configurations (18 letters to be assigned to keys)
items_assigned  = "etao"           # 4 most frequent letters (etao in English)
items_to_assign = "insrhldcumfpgw" # next 14 most frequent letters (insrhldcumfpgw in English)
...
def generate_constraint_sets():
    ...
    for comboN in itertools.combinations(positions_for_items, n_assigned):

        # Generate all permutations of these combinations
        for permN in itertools.permutations(comboN):
            pos1, pos2, pos3, pos4 = permN
