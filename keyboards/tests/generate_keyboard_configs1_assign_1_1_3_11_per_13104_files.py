...
"""
--------------------------------------------------------------------------------
Generate 13,104 configuration files to run keyboard layout optimizations 
...
OUTPUT_DIR = '../output/configs1_assign_1_1_3_11_per_13104_files'
...
items_to_assign = "nsrhldcumfp" # next 11 most frequent letters (nsrhldcumfp in English)
n_assign_first_round = 2
...
positions_for_item_2 = ["F","D","J","K"] # 4 most comfortable qwerty keys
constrain_n_keys = 16
if constrain_n_keys == 18:
    positions_for_items_3thruN = ["F","D","R","S","E","V","A","W","C",
                                  "J","K","U","L","I","M",";","O",","] # 18 most comfortable qwerty keys
elif constrain_n_keys == 16:
    positions_for_items_3thruN = ["F","D","R","S","E","V","A","W",
                                  "J","K","U","L","I","M",";","O"] # 16 most comfortable qwerty keys
# Keys to assign by the optimization process
all_N_keys = "".join(positions_for_items_3thruN)
...
def generate_constraint_sets():
    ...
    for pos1 in positions_for_item_1:
        remaining_positions2 = [pos for pos in positions_for_item_2 if pos not in [pos1]]
        for pos2 in remaining_positions2:
            remaining_positions = [pos for pos in positions_for_items_3thruN if pos not in [pos1, pos2]]
