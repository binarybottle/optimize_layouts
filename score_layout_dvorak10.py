...
Example usage:
    python score_layout_dvorak10.py --items "qwertyuiopasdfghjkl;zxcvbnm,./" --positions "QWERTYUIOPASDFGHJKL;ZXCVBNM,./"
    python score_layout_dvorak10.py --items "etaoinsrhldcumfp" --positions "FDESRJKUMIVLA;OW"
    python score_layout_dvorak10.py --items "abc" --positions "FDJ" --details
"""
...
Examples:
  ...
  python score_layout_dvorak10.py --items "abc" --positions "FDJ"
  
  # Score full layout with details
  python score_layout_dvorak10.py --items "etaoinsrhldcumfp" --positions "FDESRJKUMIVLA;OW" --details
  
  # Use custom text for analysis
  python score_layout_dvorak10.py --items "abc" --positions "FDJ" --text "abacaba"
        """
    )
